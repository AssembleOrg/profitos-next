...
> = {
  ...
  esperando: {
    dot: "bg-warning",
    chip: "border-transparent bg-sand-chip text-warning",
  },
  vencido: {
    dot: "bg-terra",
    chip: "border-transparent bg-clay-chip text-terra",
  },
  pagado: {
    dot: "bg-olive-light",
    chip: "border-transparent bg-sage-chip text-olive-light",
  },
  parcial: {
    dot: "bg-warning",
    chip: "border-transparent bg-sand-chip text-warning",
  ...
  condonado: {
    dot: "bg-text-faint",
    chip: "border-transparent bg-bg text-text-faint",
  },
};
