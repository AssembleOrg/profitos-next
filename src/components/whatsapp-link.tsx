...
/**
 * Renderiza un teléfono como link a wa.me que abre en una nueva pestaña.
 * Normaliza el número a formato internacional argentino.
 *
 * - Si no hay número válido, renderiza `fallback` (o null).
 * - `stopPropagation` (default true) evita disparar el onClick del contenedor
 *   (cards/filas clickeables).
 */
export function WhatsAppLink({
  ...
  return (
    <a
      ...
      className={className}
    >
      {withIcon && <WhatsAppGlyph size={iconSize} />}
      {children ?? phone}
    </a>
  );
}
