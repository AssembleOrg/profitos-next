              ...
              >
                <div className="flex items-start gap-2.5">
                  ...
                  <div className="min-w-0 flex-1">
                    <p className="truncate text-[13.5px] font-bold leading-tight text-text">{c.name}</p>
                    {c.email && <p className="mt-0.5 truncate text-[11px] text-text-faint">{c.email}</p>}
                    {/* Meta con iconitos: tel · alta · visitas */}
                  ...
                  {/* Acciones condensadas: WhatsApp / copiar mail */}
                  <div className="flex shrink-0 items-center gap-1.5">
                    {c.phone && (
                      <WhatsAppLink
                        phone={c.phone}
                        iconSize={14}
                        className="flex h-8 w-8 items-center justify-center rounded-full bg-sage-chip text-olive-light transition-opacity active:opacity-80"
                      >
                        {" "}
                      </WhatsAppLink>
                    )}
                    {c.email && (
                      <button
                        ...
                        className="flex h-8 w-8 items-center justify-center rounded-full bg-bg text-text-muted active:bg-surface"
                      >
