...
// Endpoint genérico para adjuntos (incluye notas de voz) de cualquier nota del sistema.
// Reutiliza el bucket "recibos" para no provisionar uno nuevo.
...
export async function POST(request: NextRequest) {
  try {
    ...
    const filePath = `notas/${safeBase}_${timestamp}.${ext}`;
    ...
    if (uploadError) {
      console.error("[Notas Upload] Error:", uploadError);
    ...
    console.error("[Notas Upload] Error:", err);
